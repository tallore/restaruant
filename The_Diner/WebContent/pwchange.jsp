...
<div class = "login_center">
	...
	<div class = "login_id">
	<input type = "hidden" name = "id" value="${stv.id }">
	<input type = "password" name = "password1" style="width:99%;height:30px;font-size:25px;" required placeholder = '새비밀번호'>
	</div>
	<div class = "login_pw">
		<input type = "password" name = "password2"  style="width:99%;height:30px;font-size:25px;" required placeholder = '비밀번호확인'>
	</div>
	<div class = "login_submit">
		<input type = "submit" name = "sub"  value="비밀번호 변경" style="width:100%;height:30px;" required>
	</div>
	</form>
