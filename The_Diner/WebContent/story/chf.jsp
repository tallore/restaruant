	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			...
			<ul class="road">
				...
				<li class="current"><span>셰프</span></li>
			</ul>
		</div>
		<!-- 메뉴이동경로 표시 - end -->
		...
		<div class="contents">
			<div class="pclist">
				<p class="img"><img src="../image/chf.jpg" width ='600px' height = '480px'></p>
				
				<pre>
			<h1>David Kim</h1>	
				<h1>쉐프 프로필</h1>
<h2>現 KAJA 식당 총괄 쉐프</h2>

前 HOTEL LOTTE 잠실 근무
前 HOTEL NEWSTAR 근무
前 리버사이드 호텔 근무
前 뉴코아 외식 사업부 수석 조리장
前 동보건설 외식 사업부 수석 조리장
前 디오/ 더루체 / 켄벤션 웨딩 총괄 쉐프
前 베트남 호치민 푸미흥 현지 수석 조리장
