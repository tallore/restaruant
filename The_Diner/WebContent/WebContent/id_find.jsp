...
<div id="middle">	
	...
	<div class="leftMenu">
		...
		<div class="lm">
			<ul class="list">
				<li class="first"><a href="id_find.jsp"><span>ID 찾기</span></a></li>
				<li class="last"><a href="pw_find.jsp"><span>PW 찾기</span></a></li>
			</ul>
		</div>
	</div>	
	<!-- leftMenu end -->
	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			<h3>ID 찾기</h3>
			<ul class="road">
				<li class="home"><span>로그인</span></li>
				<li class="current"><span>ID 찾기</span></li>
			</ul>
		</div>
		<!-- 메뉴이동경로 표시 - end -->
