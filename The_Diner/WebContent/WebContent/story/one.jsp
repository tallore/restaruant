	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			...
			<ul class="road">
				...
				<li class="current"><span>원산지</span></li>
			</ul>
		</div>
		<!-- 메뉴이동경로 표시 - end -->
		...
		<div class="contents">
			<div class="pclist">
				<table border = 0>
<tr align ="center">
	<td><img src = "../image/so.jpg" width="300px" height = "200px" vspace = 40 hspace = 20></td>
	<td><h3>소고기 : 미국산</h3></td><td>

</tr>
<tr align ="center">	
	<td><h3>연어 : 러시아산</h3></td>
	<td><img src = "../image/yeon.jpg" width="300px" height = "200px" vspace = 40 hspace = 20></td>
	
</tr>
<tr align ="center">	
	<td><img src = "../image/ya.jpg" width="300px" height = "200px" vspace = 40 hspace = 20></td>
	<td><h3>야채 : 국내산</h3></td>
</tr>
</table>
