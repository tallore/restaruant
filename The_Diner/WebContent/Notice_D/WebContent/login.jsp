...
<div class = "login_center">
	...
	<div class = "login_id">
	<input type = "text" name = "id" style="width:99%;height:30px;font-size:25px;" required>
	</div>
	<div class = "login_pw">
		<input type = "password" name = "password"  style="width:99%;height:30px;font-size:25px;" required>
	</div>
	<div class = "login_submit">
		<input type = "submit" name = "sub"  value="로그인" style="width:100%;height:30px;" required>
	</div>
	</form>
	<table border="0" class = "login_find">

		<tr align ="center">
			<td><a href ="pw_find.jsp">PW 찾기</a></td>
