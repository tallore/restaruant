...
<div id="middle">	
	...
	<% 
		...
		Review_VO vo = ndao.getOneUpdateBoard(num);
	%>
	<form action="Review_D_Updatepro.jsp" method ="post">
		<table style="width: 100%">
			...
			<tr style="min-height: 400px; align-content: center; border-bottom: 1px solid #ddd; ">
				...
				<td style="padding-left: 50px; padding-right: 50px; border-left: 1px solid #ddd; align-content: center;"><img alt="" src=""><textarea rows= "10" cols = "60" name = "content" style=" width: 100%; height: 320px; "><%=vo.getContent2()%></textarea></td>
			</tr>
			...
			<tr height= "40">
				<td colspan="2" align="center">
					...
					<input type="button" onclick = "location.href='Review_D_Listform.jsp'" value="전체 글 보기">
				</td>
			</tr>
		</table>
	</form>
