...
<div id="middle">	
	...
	<% 
		...
		//하나의 게시글로 리턴 
		Review_VO vo =  rdao.getOneUpdateBoard(num);
	%>
			<form action = "Review_D_Deletepro.jsp" method="post">
		<table style="width: 100%;">
			<tr style="height: 40px; border-bottom: 1px solid #ddd;">
				<td style="width: 35%" align ="center">작성자</td>
				<td style="padding-left: 50px; border-left: 1px solid #ddd; align-content: center;"><%=vo.getId() %></td>
			</tr>
			<tr style="height: 40px; border-bottom: 1px solid #ddd;">
				<td style="width: 35%;" align ="center">작성일</td>
				<td style="padding-left: 50px; border-left: 1px solid #ddd; align-content: center;"><%=vo.getD() %></td>
			</tr>
			
			<tr style="height: 40px; border-bottom: 1px solid #ddd;" >
				<td align = "center" width ="35%">제목</td>
				<td style="padding-left: 50px; border-left: 1px solid #ddd; align-content: center;" ><%=vo.getTitle() %></td>
			</tr>
			
			<tr style="height: 40px; border-bottom: 1px solid #ddd;">
				<td width="35%" align ="center">패스워드</td>
				<td style="padding-left: 50px; padding-right: 50px; border-left: 1px solid #ddd; align-content: center;"><input type ="password" name="password"></td>
			</tr>
			...
			<tr height="40">
				<td align ="center" colspan="3">
					...
					<input type ="button" onclick="location.href='Review_D_Listform.jsp'"value="목록보기 ">
				</td>
			</tr>
		</table>
	</form>
