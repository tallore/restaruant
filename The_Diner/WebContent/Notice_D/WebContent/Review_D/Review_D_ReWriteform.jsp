...
<div id="middle">	
	...
	%>
		<form action = "Review_D_ReWritepro.jsp" method = "post" enctype="multipart/form-data">
			<table	style="width: 100%">
				...
				<tr style="height: 40px; border-bottom: 1px solid #ddd;">
						...
						<td style="padding-left: 50px; padding-right: 50px; border-left: 1px solid #ddd; align-content: center;" ><input type= "text" name = "title" value = "&emsp; └[답변]"60" style="width: 100%"></td>
				</tr>
