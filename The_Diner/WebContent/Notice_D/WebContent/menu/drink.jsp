	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			...
			<ul class="road">
				...
				<li class="current"><span>Drink</span></li>
			</ul>
		</div>
		<!-- 메뉴이동경로 표시 - end -->
		...
		<div class="contents">
			<div class="pclist">
				<table border = 0>
<tr align ="center">
	<td><img src = "../image/d1.png" width="150px" height = "300px" >&nbsp;&nbsp;&nbsp;<br>맥주</td>
	<td><img src = "../image/d2.png" width="150px" height = "300px" >&nbsp;&nbsp;&nbsp;<br>레드와인</td>
	<td><img src = "../image/d3.png" width="150px" height = "300px" >&nbsp;&nbsp;&nbsp;<br>화이트와인</td>

</tr>
<tr align ="center">	
	<td><img src = "../image/d4.jpg" width="150px" height = "300px" >&nbsp;&nbsp;&nbsp;<br>딸기주스</td>
	<td><img src = "../image/d5.jpg" width="150px" height = "300px" >&nbsp;&nbsp;&nbsp;<br>라임주스</td>
	<td><img src = "../image/d6.jpg" width="150px" height = "300px" >&nbsp;&nbsp;&nbsp;<br>오렌지주스</td>
</tr>
