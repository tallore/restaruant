	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			...
			<ul class="road">
				...
				<li class="current"><span>Steak</span></li>
			</ul>
		</div>
		<!-- 메뉴이동경로 표시 - end -->
...
<tr align ="center">
	<td><img src = "../image/s1.png" width="280px" height = "200px"><br>립</td>
	<td><img src = "../image/s2.png" width="280px" height = "200px" ><br>안심 스테이크</td>
	<td><img src = "../image/s3.jpg" width="280px" height = "200px" ><br>송아지 스테이크</td>

</tr>
<tr align ="center">	
	<td><img src = "../image/s4.png" width="280px" height = "200px" ><br>연어 스테이크</td>
	<td><img src = "../image/s5.jpg" width="280px" height = "200px" ><br>토마호크</td>
</tr>
