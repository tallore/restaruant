	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			...
			<ul class="road">
				...
				<li class="current"><span>Pasta</span></li>
			</ul>
		</div>
		<!-- 메뉴이동경로 표시 - end -->
...
<tr align ="center">
	<td><img src = "../image/p1.jpg" width="280px" height = "200px" ><br>명란 크림파스타</td>
	<td><img src = "../image/p2.jpg" width="280px" height = "200px" ><br>브로콜리 조각 파스타</td>
	<td><img src = "../image/p3.jpg" width="280px" height = "200px" ><br>딱새우 파스타</td>

</tr>
<tr align ="center">	
	<td><img src = "../image/p4.jpg" width="280px" height = "200px" ><br>토마토 치즈 파스타</td>
	<td><img src = "../image/p5.png" width="280px" height = "200px" ><br>홍합 국물 파스타</td>
</tr>
