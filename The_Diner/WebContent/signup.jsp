...
<div id="middle">	
	...
	<!-- leftMenu -->
	<div class="leftMenu">
		<h2>Sign up<span>회원가입</span></h2>
		<div class="lm">
			<ul class="list">
				<li class="first"><a href="signup.jsp"><span>회원가입</span></a></li>
			</ul>
		</div>
	</div>	
	<!-- leftMenu end -->
	...
	<div class="menuMenu">
		...
		<div class="menuintro">
			<h3>회원가입</h3>
			<ul class="road">
				<li class="home"><span>로그인 &ensp; -</span></li>
			...
			<div class="pclist">
				<div class= "signup">
					<div class = "signup_header">
						...
						<div class = "signup_id">
					<br>아이디	<input type = "text" name = "id" style="width:99%;height:30px;font-size:20px;" required>
					</div>
					<div class = "signup_pw">
					비밀번호	<input type = "password" name = "password"  style="width:99%;height:30px;font-size:20px;" required>
					</div>
					<div class = "signup_pw2">
					비밀번호 확인	<input type = "password" name = "passwordck"  style="width:99%;height:30px;font-size:20px;" required>
					</div>
					<div class = "signup_name">
					이름	<input type = "text" name = "name"  style="width:99%;height:30px;font-size:20px;" required>
					</div>
					<div class = "signup_email">
					이메일	<input type = "email" name = "email"  style="width:99%;height:30px;font-size:20px;" required>
					</div>
					<div class = "signup_tel">
					전화번호	<input type = "tel" name = "tel"  style="width:99%;height:30px;font-size:20px;" required>
					</div>

					<div class = "signup_jumin">
					주민번호<br>
					<span><input type="tel"  id="knum" name="knum" maxlength="6" style="width:48%;height:30px;font-size:20px;"> 
				        - <input type="password" id="knum2" name="knum2" maxlength="7" style="width:48%;height:30px;font-size:20px;">
				         
			        </span>
           			</div>
        		   <div class = "signup_submit">
					<br>	<input type = "submit" name = "sub"  value="가입하기" style="width:100%;height:30px;" required>
					</div>
</form>
				</div>
